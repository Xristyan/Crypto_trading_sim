        ...
        <div className="flex items-center">
          {user ? (
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center bg-gray-50 px-3 py-1.5 rounded-full text-sm text-gray-500">
              ...
              <Link
                href={"/profile"}
                className="hidden md:block text-sm bg-blue-500 hover:bg-blue-600 text-white px-3 py-1.5 rounded-md transition-colors"
              >
                Profile
              </Link>
              <button
